...
export const Cog6ToothIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0 0 15 0m-15 0a7.5 7.5 0 1 1 15 0m-15 0H3m18 0h-1.5m-15 0H3.75m16.5 0h.75m-1.5-6.435A7.5 7.5 0 0 1 12 3.75m0 0a7.5 7.5 0 0 1 7.5 7.5m-7.5-7.5V3m0 18v-1.5m0 0a7.5 7.5 0 0 0 7.5-7.5M12 21a7.5 7.5 0 0 0-7.5-7.5m7.5 7.5V21m-7.5-9H3.75m16.5 0h.75M12 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z" />
    </svg>
);
...
export const SunIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.95-4.243-1.591 1.591M5.25 12H3m4.243-4.95L6.036 5.636M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
    </svg>
);
...
export const UsersIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-2.253-9.58 9.58 0 0 0-1.659-3.992.942.942 0 0 0-.226-.296 9.363 9.363 0 0 0-1.659-1.321c-.378-.262-.832-.39-1.328-.398a9.034 9.034 0 0 0-1.32 0c-.496.008-.95.136-1.328.398-1.574.9-2.865 2.44-3.3 4.223a9.38 9.38 0 0 0 2.625.372M10.5 15.128c1.574.9 2.865 2.44 3.3 4.223a9.38 9.38 0 0 0-2.625.372 9.337 9.337 0 0 0-4.121-2.253 9.58 9.58 0 0 0 1.659-3.992.942.942 0 0 0 .226-.296 9.363 9.363 0 0 0 1.659-1.321c.378-.262.832-.39 1.328-.398a9.034 9.034 0 0 0 1.32 0c.496.008.95.136 1.328.398m-3.3 4.223-3.3-4.223m3.3 4.223a9.033 9.033 0 0 0-3.3-4.223" />
    </svg>
);
